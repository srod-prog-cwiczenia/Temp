...
\put(81,48){\vector(3,2){15}}%% Lac -> I_{d}
\put(79,48){\vector(-3,2){15}}%% Lac -> H

\put(140,39){\vector(0,1){16}}% W -> nPS

\put(80,13){\vector(4,3){23}}% Fin->I_{1/n}
\put(140,32){\vector(-3,2){35}} % W -> I_d
\put(87,13){\vector(3,1){52}} %Fin->W
...
$\mathit{nPS}$ - \= ideał zbiorów not Piecewise Syndedic
\end{tabbing}
\end{document}
